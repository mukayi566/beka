        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            { label: 'Audience Authenticity', value: 98, icon: <ShieldCheck size={20} />, color: 'text-fuchsia-500' },
            ...
            <div className="glass-card rounded-[3rem] p-10 bg-gradient-to-r from-primary/10 to-transparent border-primary/10">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <button className="px-8 py-4 bg-primary text-on-primary font-bold rounded-2xl brand-glow whitespace-nowrap">
