                ...
                {[
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            <div className="p-3 rounded-2xl bg-black/5">{stat.icon}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 glass-card rounded-[2.5rem] p-8">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <select className="bg-black/5 border border-black/5 rounded-xl px-4 py-2 text-sm font-bold">
                ...
                <div className="space-y-6">
                    <div className="glass-card rounded-[2.5rem] p-8 bg-primary/10 border-primary/20">
                        ...
                        <button className="w-full mt-6 py-4 bg-primary text-on-primary font-bold rounded-2xl brand-glow text-sm">
                            View Wallet
                        </button>
                    </div>
                            ...
                            {[
                                ...
                                <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-black/5 border border-black/5">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-xl bg-black/5 flex items-center justify-center font-bold">{campaign.brand[0]}</div>
                                        <div>
