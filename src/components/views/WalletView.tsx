        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            <header className="flex justify-between items-center">
                ...
                <div className="flex gap-4">
                    ...
                    <button className="bg-primary text-on-primary px-6 py-3 rounded-2xl font-bold flex items-center justify-center gap-2 brand-glow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 glass-card rounded-[3rem] p-10 bg-gradient-to-br from-primary/20 via-surface to-surface relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-12">
                        ...
                        <div className="flex gap-2">
                            ...
                            <div className="px-3 py-1 rounded-full bg-black/5 text-foreground/50 text-[10px] font-bold">KES 1,200,000</div>
                        </div>
                    </div>

                    <div className="flex flex-wrap gap-4">
                        <button className="flex-1 min-w-[160px] py-4 bg-primary text-on-primary font-bold rounded-2xl flex items-center justify-center gap-2 brand-glow">
                            <ArrowUpRight size={20} /> Withdraw Now
                        </button>
                        <button className="flex-1 min-w-[160px] py-4 bg-black/5 border border-black/5 font-bold rounded-2xl flex items-center justify-center gap-2 hover:bg-black/5 transition-all">
                ...
                <div className="glass-card rounded-[3rem] p-8 space-y-6">
                    ...
                    <div className="p-6 rounded-[2rem] bg-black/5 border border-primary/20 relative group hover:border-primary/50 transition-all cursor-pointer">
                    ...
                    <button className="w-full py-4 text-sm font-bold text-foreground/40 border border-black/5 border-dashed rounded-[2rem] hover:text-foreground hover:bg-black/5 transition-all">
                        + New Payout Method
                    </button>
                </div>
            </div>
            ...
            <div className="glass-card rounded-[3rem] overflow-hidden">
                <div className="p-8 border-b border-black/5 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className="px-4 py-2 text-xs font-bold text-foreground/40 hover:bg-black/5 rounded-full">Earnings</button>
                        <button className="px-4 py-2 text-xs font-bold text-foreground/40 hover:bg-black/5 rounded-full">Payouts</button>
                    </div>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-white/5">
                            {[
                                ...
                                <tr key={i} className="hover:bg-black/5 transition-all">
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-4">
                                            <div className={cn(
                                                "w-10 h-10 rounded-xl flex items-center justify-center",
                                                tx.type === 'in' ? "bg-primary/20 text-primary" : "bg-black/5 text-foreground/60"
                                            )}>
                                    ...
                                    <td className="px-8 py-6">
                                        <span className={cn(
                                            ...
                                            tx.status === 'Completed' ? "bg-primary/20 text-primary" : "bg-black/5 text-foreground/60"
                                        )}>{tx.status}</span>
                                    </td>
                                    <td className={cn(
